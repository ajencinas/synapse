"""Standalone model architecture for SynapseGPT.

Extracted from pretrain/train.py so the outlier probe notebook can import
model classes and constants without triggering train.py's top-level code
(shard loading, optimizer setup, training loop, etc.).
"""
...
# ==================== MODEL HYPERPARAMETERS (Shape D, ~2.1B params) ====================
EMBED_DIM      = 2560
NUM_LAYERS     = 28
